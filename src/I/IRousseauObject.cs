...
namespace PPWCode.Vernacular.Semantics.I
{
    ...
    ///         of the <c>IRousseauObject</c>.
    ///     </para>
    ///     <para>
    ///         <see cref="AbstractRousseauObject" /> offers hard implementations that
        ...
        ISemanticObject
    {
        ...
        ///     exception.
        /// </summary>
        /// <returns>A <see cref="bool"/> indicating whether the object is civilized.</returns>
        [Pure]
        bool IsCivilized();
    ...
    /// <exclude />
    /// <summary>This is a dummy contract class for <see cref="IRousseauObject"/>.</summary>
